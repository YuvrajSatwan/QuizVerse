  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const quizData = {
        ...
        createdBy: localStorage.getItem('playerName') || 'Quiz Creator',
        status: 'waiting',
        currentQuestion: 0,
        showResults: false,
      ...
      localStorage.setItem('userId', quizId) // Temporary user ID for host
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Sign in to create, manage, and track your quizzes
              </p>
            </div>
            ...
            <div className="mt-6 text-sm text-gray-500">
              ...
              <ul className="mt-2 space-y-1">
                <li>• Create and manage multiple quizzes</li>
                <li>• Track quiz performance and analytics</li>
                <li>• Save quiz templates for reuse</li>
              </ul>
            </div>
          </motion.div>
        </div>
